...
class PosTaxReport(models.TransientModel):
    ...
    _description = 'Point of Sale Tax Report'
    ...
    def generate_report(self):
        ...
        data = {'date_start': self.start_date, 'date_stop': self.end_date, 'config_ids': self.pos_config_ids.ids, 'config_id': self.pos_config_id.id}
        return self.env.ref('custom_pos_receipt.pos_tax_report').report_action([], data=data)
