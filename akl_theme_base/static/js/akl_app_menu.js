odoo.define('akl_theme_base.AppsMenu', function (require) {
    ...
    var aklAppsMenu = Widget.extend({
        ...
        start: function () {
            ...
            core.bus.on('DOM_updated', null, debouncedAdapt);
            $(".o_main_navbar").css("height", "88px");
        },

        _init_auto_more: function () {
            //drag and drop menu by nabil
            /*$( "#nabil_sortable" ).sortable();
            $( "#nabil_sortable" ).disableSelection();*/
            var view_more_width = this.$('.view_more').outerWidth(true);
            //update nabil yahia
            var max_width = this.$el.width()-70;
