...
class Insurance(models.Model):
    ...
    allow_appointment_insurance = fields.Boolean(string="Insured Appointment", default=False)
    ...
    def onchange_insurance_company(self):
        if self.insurance_company_id and self.insurance_company_id.pricelist_id:
            self.pricelist_id = self.insurance_company_id.pricelist_id.id
...
class InsuranceClaim(models.Model):
    ...
    claim_for = fields.Selection([
        ...
        ('other', 'Other')], string='Claim Type', default='hospitalization', required=True)
