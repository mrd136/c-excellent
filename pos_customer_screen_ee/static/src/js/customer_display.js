odoo.define('pos_customer_screen_ee.customer_display', function (require) {
"use strict";
	...
	var CustomerDisplayScreen = CustomerDisplayWidget.extend({
	    ...
	    init: function() {
	        ...
	        self.company_logo = window.location.origin+"/web/binary/company_logo?db=pos_customer_screen_ee_v12&company="+self.company_id;
	    },
	    start: function(){
	    	this._super();
	    	var self = this;
