...
class PosConsumptionReport(models.TransientModel):
    
    _name = 'pos.consumption.report.wizard'

    _description = 'Point of consumption Report'
    ...
    #pos_config_ids = fields.Many2many('pos.config', 'pos_details_configs')
   # pos_config_ids = fields.Many2many('pos.config', 'pos_detail_configs',
    ...
    def generate_report(self):
        ...
        if (not self.env.company.external_report_layout_id):
        ...
        return self.env.ref('pos_mrp_order.pos_consumption_report').report_action([], data=data)
