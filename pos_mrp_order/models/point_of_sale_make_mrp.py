...
# class POSProductionCons(models.Model):
#     _name=pos.consumption.report
#     pos_session_id = fields.Many2one('pos.session', string='Pos Session')
#     pos_config_id = fields.Many2one('pos.config', related='pos_session_id.config_id', string='Point Of Sale', store=True)
                    ...
                    if bom_count:
                        ...
                        if bom:
                            vals = {
                                ...
                                'bom_id': bom.id,
                                'pos_session_id': prod['session_id'],
                            }
