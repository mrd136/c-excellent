...
class gen_partner(models.TransientModel):
    ...
    def create_partner(self, values):
        ...
        if partner_search:
            ...
            if is_customer:
                res = self.env['res.partner'].with_context(res_partner_search_mode='customer').create(vals)
            if is_supplier:
                res = self.env['res.partner'].with_context(res_partner_search_mode='supplier').create(vals)
