        ...
        if self.import_option == 'csv': 
            ...
            for i in range(len(file_reader)):
                ...
                try:
                     ...
                     raise exceptions.Warning(_("Don't Use Character only use numbers"))
                ...
                if self.lot_option == True:
                    if self.location_id_option == True:
                        ...
                        if bool(val):
                            ...
                            inventory_id.action_open_inventory_lines()
                            lines = self.env['stock.inventory.line'].create({'product_id':val['product'] , 'inventory_id' : inventory_id.id , 'product_uom_id' : product_uom_id.id  ,'product_qty': val['quantity'],'prod_lot_id':lot_id.id})
                        ...
                        if self.location_id_option == True:
                            ...
                            if line:
                                ...
                                if bool(val):
                                    ...
                                    inventory_id.action_open_inventory_lines()
                                    lines = self.env['stock.inventory.line'].create({'product_id':val['product'] ,'inventory_id' : inventory_id.id ,'location_id' : self.location_id.id, 'product_uom_id' : product_uom_id.id  ,'product_qty': val['quantity'],'prod_lot_id':lot_id.id})
                        ...
                        if self.location_id_option == True:
                            ...
                            if line:
                                ...
                                if bool(val):
                                    ...
                                    inventory_id.action_open_inventory_lines()
                                    lines = self.env['stock.inventory.line'].create({'product_id':val['product'] ,'inventory_id' : inventory_id.id , 'location_id' : self.location_ids.id, 'product_uom_id' : product_uom_id.id  ,'product_qty': val['quantity'],'prod_lot_id':lot_id.id})
