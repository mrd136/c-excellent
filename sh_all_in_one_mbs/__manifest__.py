...
# Copyright (C) Softhealer Technologies.
{
    ...
    "summary": "invoice mobile qrcode scanner, bom mobile barcode scanner app, stock adjustment qrcode scan, request for quotation mobile barcode scanner, product mobile barcode scanner, warehouse mobile qrcode, account mobile qrcode scanner, purchase barcode Odoo",
...
debit note barcode mobile scanner
    ...
    'qweb': [
        "static/src/xml/sh_inventory_adjustment_barcode_mobile.xml",
    ],       
