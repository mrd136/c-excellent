...
//	console.log('========yyyyyyy===========')
    models.load_fields("hr.employee", ['pos_user_type', 'sales_persons']);
//	models.load_models({
//		model:  'res.users',
...
////			return [
////				['id', 'in', self.pos.config.cashier_id.id]
////			];
////		},
...
//            self.employee.id = self.id
//            self.employee.pos_user_type = self.pos_user_type;
...
//            	var order_lines = self.get_orderlines_from_order(result.lines);
        ...
        click_edit_order: function(event){
            ...
            if(result && result.lines.length > 0){
                ...
                console.log($(event.currentTarget).data('operation'))
    ...
    models.Order = models.Order.extend({
        ...
        export_as_JSON: function() {
            ...
            console.log(this.pos.get_cashier().pos_user_type)
//            orders.employee_id = undefined;
...
//        }
		...
		_save_to_server: function (orders, options) {
			...
			.then(function(server_ids){
			    console.log("00000000000", server_ids)
            ...
            if (self.pos.config.enable_reorder){
                this.$('.pay').unbind('click').click(function(){
                    ...
                    if(order.table && order.table.is_for_delivery){
                        ...
                        console.log('===========>self.pos.get_cashier().pos_user_type<=================')
